...
import com.andile.student.dao.StudentDAO;
...
//        studentDAO.insertStudent(student);
        ...
        System.out.println("Student deleted :"+studentDAO.deleteStudent(2L));

        //update a student record in the database
        studentDAO.updateStudent(new Student("Andile","23793 Orange Street","0614723334","andilegumada@gmail.com"));
